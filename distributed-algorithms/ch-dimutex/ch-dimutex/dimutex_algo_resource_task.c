...
static uint32_t dimutex_algo_get_rand_bw_10_20();

static uint32_t dimutex_algo_get_rand_bw_40_50();
   ...
   DIMUTEX_CTXT_X *px_dimutex_ctxt)
{
         ...
         ui_index++)
   {
      ...
      DMUT_LOG_LOW("[RES]Sending dimutex_node_send_algo_request to %d. Our "
         "Seq No.: %d", ui_index, px_db->ui_our_seq_no);
